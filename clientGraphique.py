...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        validate_button = Button(self, text="Valider", font=("Courrier", 25), bg='green', fg='white', 
...
class PageMain(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.chat_box.grid(column=0, row=0, sticky='w', columnspan=4)    

        self.text_box = tk.Entry(self)
        self.text_box.grid(column=0, row=2,sticky="NSEW",pady=10,padx=(10,0))

        btn_send = Button(self, text="Send Message", font=("Courrier", 12), bg="green", fg="white", 
